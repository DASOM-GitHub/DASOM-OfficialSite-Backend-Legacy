...
public class StudyController {
    ...
    public StudyController(StudyService studyService){
        this.projectService = studyService;
    }
    ...
    public ResponseEntity<ApiResponse<Study>> getStudy(@PathVariable("project_no") int project_no){
        try{
    ...
    public ResponseEntity<ApiResponse<Study>> create(@ModelAttribute Study project, @RequestParam(value = "projectFile") MultipartFile projectFile){
        try {
...
//    }
    ...
    public ResponseEntity<ApiResponse<List<StudyParticipants>>> getParticipants(@PathVariable("project_no") int project_no) {
        try {
            return ResponseEntity.status(HttpStatus.OK).body(new ApiResponse<>(
    ...
    public ResponseEntity<ApiResponse<StudyParticipants>> addParticipants(@PathVariable("project_no") int project_no,@ModelAttribute StudyParticipants projectParticipants) {//@ModelAttribute Role role
        System.out.println(projectParticipants.getStudyNo()+" "+projectParticipants.getParticipantNo());
        try {
    ...
    public ResponseEntity<ApiResponse<StudyParticipants>> removeParticipants(@PathVariable("project_no") int project_no,@ModelAttribute StudyParticipants projectParticipants) {
        try {
